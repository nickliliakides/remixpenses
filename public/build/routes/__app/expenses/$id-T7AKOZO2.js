import {
  ExpenseForm_default,
  Modal_default
} from "/build/_shared/chunk-F4BZNEG4.js";
import {
  require_expenses
...
var meta = ({ params, location, data, parentsData }) => {
  console.log("\u{1F680} ~ file: $id.jsx:47 ~ meta ~ data:", data);
  console.log("\u{1F680} ~ file: $id.jsx:47 ~ meta ~ location:", location);
  console.log("\u{1F680} ~ file: $id.jsx:47 ~ meta ~ params:", params);
  console.log("\u{1F680} ~ file: $id.jsx:47 ~ meta ~ parentsData:", parentsData);
...
//# sourceMappingURL=/build/routes/__app/expenses/$id-T7AKOZO2.js.map
